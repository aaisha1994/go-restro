         ...
         <div class="d-flex align-items-stretch" id="kt_header_nav">
            <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
               <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                  ...
                  <div class="menu-item {{ Request::route()->getName() === 'dashboard' ? 'here show' : '' }} menu-lg-down-accordion me-lg-1">
                  ...
                  <div class="menu-item {{ Request::route()->getName() === 'passport' ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                      <a class="menu-link py-3" href="{{ route('passport') }}">
                          <span class="menu-title">Passport</span>
                          <span class="menu-arrow d-lg-none"></span>
                      </a>
                  </div>

                  <div class="menu-item {{ Request::route()->getName() === 'send-gift' ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                      <a class="menu-link py-3" href="{{ route('send-gift') }}">
                          <span class="menu-title">Send Gift</span>
                          <span class="menu-arrow d-lg-none"></span>
                      </a>
                  </div>

                  <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1 {{ Request::route()->getName() === 'restro-qr' || Request::route()->getName() === 'restro-qr-invites' ? 'show' : '' }}">
                      <span class="menu-link py-3">
                          <span class="menu-title">QR Code</span>
                          <span class="menu-arrow d-lg-none"></span>
                      </span>
                      <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                          <div class="menu-item {{ Request::route()->getName() === 'restro-qr' ? 'active' : '' }}">
                              <a class="menu-link py-3" href="{{ route('restro-qr') }}" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                  <span class="menu-icon"><i class="bi bi-qr-code-scan"></i></span>
                                  <span class="menu-title">QR Reedem</span>
                              </a>
                          </div>
                          <div class="menu-item {{ Request::route()->getName() === 'restro-qr-invites' ? 'active' : '' }}">
                              <a class="menu-link py-3" href="{{ route('restro-qr-invites') }}" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                  ...
                  <div class="menu-item menu-lg-down-accordion me-lg-1 {{ Request::route()->getName() === 'restro-users' ? 'show' : '' }}">
                      <a class="menu-link py-3" href="{{ route('restro-users') }}">
         ...
         <div class="topbar d-flex align-items-stretch flex-shrink-0">
                     ...
                     <div class="tab-pane fade" id="kt_topbar_notifications_2" role="tabpanel">
                        <div class="d-flex flex-column px-9">
                           ...
                           <div class="text-center px-4">
                              <img class="mw-100 mh-200px" alt="image" src="restaurant/media/illustrations/sigma-1/1.png" />
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="d-flex align-items-center me-n3 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
               ...
               <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                  <div class="menu-item px-3">
                     <div class="menu-content d-flex align-items-center px-3">
                        <div class="symbol symbol-50px me-5">
                           <img alt="Logo" src="restaurant/media/avatars/300-2.jpg" />
                        </div>
                  ...
                  <div class="menu-item px-5">
                     <a href="{{Route('sign-in')}}" class="menu-link px-5">Sign Out</a>
                  </div>
               </div>
            </div>
         </div>
