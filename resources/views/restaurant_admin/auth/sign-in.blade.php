...
<html lang="en">
   ...
   <body id="kt_body" class="bg-body">
      <div class="d-flex flex-column flex-root">
         <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(restaurant/media/illustrations/dozzy-1/14.png)">
                  ...
                  <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="#!" action="#">
                     <div class="text-center mb-10">
                        ...
                        <div class="text-gray-400 fw-bold fs-4">New Here?
                           <a href="{{Route('sign-up')}}" class="link-primary fw-bolder">Create an Account</a>
                        </div>
                     </div>
                     ...
                     <div class="fv-row mb-10">
                        <div class="d-flex flex-stack mb-2">
                           ...
                           <a href="{{Route('password-reset')}}" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
                        </div>
