...
@section('title', 'Restro Create')
@section('toolbar', 'Restro Create')
@section('content')
    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
        <div class="content flex-row-fluid" id="kt_content">
            <form id="form" class="form" action="{{ route('affiliate.restro.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4 mt-5">
                                <div class="fv-row mb-10">
                                    ...
                                    <input type="text" name="price_per_person" class="form-control form-control-solid mb-3 mb-lg-0" />
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 mt-5">
                                <div class="fv-row mb-10">
                            ...
                            <div class="col-sm-12 col-md-4 mt-5">
                                <div class="fv-row mb-10">
                                    ...
                                    <input type="number" id="zip-code" pattern="[0-9]*" name="zip_code"
                            ...
                            <div class="col-sm-12 col-md-4 mt-5">
                                <div class="fv-row mb-10">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        <div class="me-10">
                                            <input class="form-check-input" type="checkbox" name="meal_preference[]" value="veg" />
                                            <label class="form-check-label">Veg</label>
                                        </div>
                                        <div class="me-10">
                                            <input class="form-check-input" type="checkbox" name="meal_preference[]" value="nonveg" />
                                            <label class="form-check-label">Non-Veg</label>
                                        </div>
                                        <div>
                                            <input class="form-check-input" type="checkbox" name="meal_preference[]" value="vegans" />
