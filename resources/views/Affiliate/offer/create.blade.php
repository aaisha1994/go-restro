...
@section('title', 'Restaurant Offers Add')
@section('toolbar', 'Restaurant Offers Add')
@section('content')
        ...
        <div class="content flex-row-fluid" id="kt_content">
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <form id="form" class="form" action="{{ route('affiliate.offer.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4 mt-5">
                                <div class="fv-row mb-10">
                                    ...
                                    <input type="text" name="details" class="form-control form-control-solid mb-3 mb-lg-0" />
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 mt-5">
                                <div class="fv-row mb-10">
                                    <label class="required fw-bold fs-6 mb-2">Coupon Quantity.</label>
                                    <input type="number" name="quantity" class="form-control form-control-solid mb-3 mb-lg-0" pattern="[0-9]{10}" />
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 mt-5">
                                <div class="fv-row mb-10">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="fv-row mt-5">
                                    <img id="showImage" class="rounded avatar-lg w-100px h-100p"
                            ...
                            <div class="col-sm-12 col-md-12 mt-5">
                                <div class="fv-row mb-10">
                                    ...
                                    <textarea class="form-control form-control-solid mb-3 mb-lg-0" name="terms"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="text-end">
