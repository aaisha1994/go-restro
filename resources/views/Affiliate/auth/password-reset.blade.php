...
<head>
    <title>GoRestro | Affiliate Forgot Password</title>
    <meta charset="utf-8" />
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{ asset('restaurant/media/illustrations/dozzy-1/14.png') }})">
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<form method="POST" action="{{ route('affiliate.resetsend',[$token]) }}" class="form w-100" novalidate="novalidate" id="kt_password_reset_form">
							...
							<div class="d-flex flex-wrap justify-content-center pb-lg-0">
								...
								<a href="{{ route('affiliate.login') }}" class="btn btn-lg btn-light-primary fw-bolder returnlogin">Cancel</a>
							</div>
						</form>
					</div>
				</div>
