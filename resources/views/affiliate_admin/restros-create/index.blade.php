         ...
         <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
               <div class="d-flex justify-content-end">
                  <a href="{{Route('create-restro')}}" class="btn btn-primary">Add Restaurant</a>
               </div>
            </div>
         </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
               ...
               <tbody class="fw-bold text-gray-600">
                  <tr>
                     ...
                     <td class="text-gray-600 text-hover-primary mb-1">+91 8532652326</td>
                     <td>&#8377; 399</td>
                     ...
                     <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                           <div class="menu-item px-3">
                              <a href="{{Route('edit-restro')}}" class="menu-link px-3">View</a>
                           </div>
                           <div class="menu-item px-3">
                  ...
                  <tr>
                     ...
                     <td class="text-gray-600 text-hover-primary mb-1">melody@altbox.com</td>
                     <td class="text-gray-600 text-hover-primary mb-1">+91 2356956235</td>
                     <td>&#8377; 499</td>
