...
<html lang="en">
   <head> 
      <title>GoRestro | Affiliate Dashboard</title>
      <meta charset="utf-8"/>
   ...
   <body id="kt_body" style="background-image: url(restaurant/media/patterns/1.png)" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
      <div class="d-flex flex-column flex-root">
         <div class="page d-flex flex-row flex-column-fluid">
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">

               <!--begin::Header-->
                  @include('affiliate_admin.layouts.header')
               <!--begin::Toolbar-->
                        ...
                        <div class="page-title d-flex flex-column me-3">
                           ...
                           <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                              <li class="breadcrumb-item text-white opacity-75">
                                 <span class="text-white text-hover-primary">Hi Max Smith , Welcome back!</span>
               ...
               <!--begin::Footer-->
                  @include('affiliate_admin.layouts.footer')
               <!--end::Footer-->
