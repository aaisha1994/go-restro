         ...
         <div class="d-flex align-items-stretch" id="kt_header_nav">
            <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
               <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                  ...
                  <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1 {{ Request::route()->getName() === 'affiliate-restros' || Request::route()->getName() === 'affiliate-offer' ? 'show' : '' }}">
                      <span class="menu-link py-3">
                          <span class="menu-title">Restros & Offers</span>
                          <span class="menu-arrow d-lg-none"></span>
                      </span>
                      <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                          <div class="menu-item {{ Request::route()->getName() === 'affiliate-restros' ? 'active' : '' }}">
                              <a class="menu-link py-3" href="{{ route('affiliate-restros') }}" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                  <span class="menu-icon"><i class="bi bi-building-add"></i></span>
                                  <span class="menu-title">Create Restros</span>
                              </a>
                          </div>
                          <div class="menu-item {{ Request::route()->getName() === 'affiliate-offer' ? 'active' : '' }}">
                              <a class="menu-link py-3" href="{{ route('affiliate-offer') }}" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                  <span class="menu-icon"><i class="bi bi-building-add"></i></span>
                  ...
                  <div class="menu-item {{ Request::route()->getName() === 'payment-details' ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                      <a class="menu-link py-3" href="{{ route('payment-details') }}">
                  ...
                  <div class="menu-item {{ Request::route()->getName() === 'affiliateqr-management' ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                      <a class="menu-link py-3" href="{{ route('affiliateqr-management') }}">
         ...
         <div class="topbar d-flex align-items-stretch flex-shrink-0">
            <div class="d-flex align-items-center ms-1 ms-lg-3">
               ...
               <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                  <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('restaurant/media/misc/pattern-1.jpg')">
            ...
            <div class="d-flex align-items-center me-n3 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
               <div class="btn btn-icon btn-active-light-primary btn btn-icon btn-active-light-primary btn-custom w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                  <img class="h-30px w-30px rounded" src="restaurant/media/avatars/300-2.jpg" alt="" />
               </div>
               <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                  <div class="menu-item px-3">
                     <div class="menu-content d-flex align-items-center px-3">
                        <div class="symbol symbol-50px me-5">
                           <img alt="Logo" src="{{asset('restaurant/media/avatars/300-2.jpg')}}" />
                        </div>
                  ...
                  <div class="menu-item px-5">
                     <a href="{{Route('affiliate.login')}}" class="menu-link px-5">Sign Out</a>
                  </div>
               </div>
            </div>
         </div>
