                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col">
                          <div class="d-grid gap-2 d-flex justify-content-end">
                            <a href="{{Route('faqs-create')}}" class="btn btn-sm btn-primary" type="button">&#43; Add FAQS</a>
                          </div>
                        </div>
                      </div>
                          ...
                          <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                              ...
                              <tbody>
                                  <tr>
                                      ...
                                      <td>Lorem Ipsum is simply dummy text of the printing and industry...</td>
                                      <td>Restaurant</td>
                                      <td id="tooltip-container9" class="d-flex justify-content-end">

                                           <a href="{{Route('faqs-edit')}}" class="me-1 btn btn-sm btn-secondary" data-bs-container="#tooltip-container9" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Edit" data-bs-original-title="Edit"><i class="mdi mdi-pencil font-size-14"></i></a>
