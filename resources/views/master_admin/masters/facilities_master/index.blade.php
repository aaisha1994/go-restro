                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col">
                          <div class="d-grid gap-2 d-flex justify-content-end">
                            <a href="{{Route('facilities-create')}}" class="btn btn-sm btn-primary" type="button">&#43; Add Facility</a>
                          </div>
                        </div>
                      </div>
                              ...
                              <tbody>
                                  <tr>
                                      ...
                                      <td id="tooltip-container9" class="d-flex justify-content-start">
                                           ...
                                           <a href="{{Route('facilities-edit')}}" class="me-1 btn btn-sm btn-secondary" data-bs-container="#tooltip-container9" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Edit" data-bs-original-title="Edit"><i class="mdi mdi-pencil font-size-14"></i></a>
