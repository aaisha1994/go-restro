    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="d-lg-inline-block ms-1">
                <a href="{{route('admin-giftsend')}}" class="btn header-item noti-icon waves-effect" style="display: table-cell;">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{asset('assets/images/users/logo.png')}}"
                        alt="user image">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item text-danger" href="{{Route('login')}}"><i class="ri-shut-down-line align-middle me-1 text-danger"></i> Logout</a>
                </div>
            </div>
