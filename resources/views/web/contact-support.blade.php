        ...
        <div class="row">
            <div class="col-md-8 col-lg-6">
                <div class="banner_title_inner">
                    <h1 data-aos="fade-up" data-aos-delay="0">Contact Support</h1>
                    ...
                    <form action="{{ route('inquiry') }}" method="POST" class="row" id="form">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="first_name" placeholder="ex. John">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="dob" id="dob" placeholder="ex. 21/09/1998">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
