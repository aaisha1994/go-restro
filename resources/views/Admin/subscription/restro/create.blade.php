...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            <!-- start page title -->
            <form action="{{ route('admin.restrosubscription.store') }}" method="POST" id="form">
                @csrf
                <div class="row">
                    <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div>
                                            ...
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox" value="1" id="gift-send" name="gift_send">
                                                <label class="form-check-label" for="gift-send">Gift Send</label>
                                            </div>
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox" value="1" id="compliment-gr-coin" name="compliment_coin">
                                    ...
                                    <div class="col-md-3">
                                        <div>
                                            <h5 class="font-size-14 mb-3">Select Checkboxes</h5>
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox" value="1" id="event-details" name="event_details">
                                                <label class="form-check-label" for="event-details">Event Details</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1" id="staff-allocation" name="staff_allocation">
                                                <label class="form-check-label" for="staff-allocation">Staff Allocation</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4" id="gr-coin-field" style="display: none;">
                                        <label class="form-label" for="gr-coin">Add GR Coin *</label>
                                        <input type="number" class="form-control" id="gr-coin" name="gr_coin">
                                    </div>
