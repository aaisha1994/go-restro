...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            <!-- start page title -->
            <form action="{{ route('admin.promotion.store') }}" method="POST" id="form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="promotion_name" name="name">
                                    </div>
                                    <div class="col-md-4 mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-5">
                                        ...
                                        <div class="input-daterange input-group flex-container" style="flex-wrap: nowrap" id="datepicker6" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container="#datepicker6">
                                            <div><input type="text" class="form-control" name="start_date" placeholder="Start Date"></div>
                                            <div><input type="text" class="form-control" name="end_date" placeholder="End Date"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
